...
const NOTIF: Record<string, Record<string, string>> = {
  fr: {
    ...
    "hc.fix.detail.noTextStyle": "aucun style de texte Marcel ne correspond a cette taille",
  ...
  en: {
    ...
    "hc.fix.detail.noTextStyle": "no Marcel text style matches this size",
  ...
  "pt-BR": {
    ...
    "hc.fix.detail.noTextStyle": "nenhum estilo de texto Marcel corresponde a este tamanho",
